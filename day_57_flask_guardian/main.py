...
@app.route('/')
def home():
    return render_template("index.html", all_posts=all_content)
...
def get_article(article_id):
    ...
    article_obj = Post(article["id"], article["webTitle"], article["fields"]["trailText"], article["fields"]["thumbnail"], article["fields"]["bodyText"])
